  ...
  <div className="space-y-1.5">
    ...
    <div className="relative">
      ...
      <input
        ...
        className={`${inputClass} ${icon ? 'pl-11' : ''} ${error ? 'border-red-500/60 focus:ring-red-500/30' : ''}`}
      />
    </div>
    {error && (
      <p className="text-sm text-red-400 flex items-center gap-1 mt-1" style={{ fontFamily: "'Tinos', serif" }}>
  ...
  return (
    <div className="bg-white/6 rounded-2xl border border-white/10 p-6 md:p-8">
      <div className="flex items-center gap-3 mb-6">
        ...
        <div>
          <h3 className="text-lg font-bold text-white" style={{ fontFamily: "'Science Gothic', sans-serif" }}>Contact Information</h3>
          <p className="text-sm text-white/40" style={{ fontFamily: "'Tinos', serif" }}>We'll use this to confirm your order</p>
        </div>
      </div>
